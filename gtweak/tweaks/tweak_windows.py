...
TWEAKS = (
    GSettingsComboEnumTweak("Focus Mode", "org.gnome.desktop.wm.preferences", "focus-mode", group_name=TWEAK_GROUP_WINDOWS, sort=TWEAK_SORT_FIRST),
    ...
    #Title("Titlebar Buttons","", group_name=TWEAK_GROUP_WINDOWS),
