...
class Window(Gtk.ApplicationWindow):
    ...
    def titlebar(self):
        ...
        left_header.pack_start(lbl)

        hbar.pack_start(left_header, False, False, 0)
        hbar.pack_start(separator, False, False, 0)
        hbar.pack_start(self.right_header, True, True, 0)
